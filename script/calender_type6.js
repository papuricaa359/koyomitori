function generateCalendar_type6() {
  ...
  const monthYearY = startY - 10;
  const monthAreaWidth = 60;
  ctx.fillStyle = "#000";
  ctx.font = `bold ${bigFontSize}px '${font}'`;
  ctx.textAlign = "center";
  ctx.textBaseline = "alphabetic";
  ctx.fillText(month.toString(), startX + monthAreaWidth / 2, monthYearY);
  ctx.font = `bold 32px '${font}'`;
  ctx.textAlign = "left";
  ctx.textBaseline = "alphabetic";
  ctx.fillText(`${year}`, startX + monthAreaWidth + 6, monthYearY);
