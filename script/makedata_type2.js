function drawAndCalendar_type2(image) {
  ...
  const displayWidth = 886;
  const displayHeight = displayWidth/cropAspectRatio;
  const posY = (canvasHeight - displayHeight) / 2;
  ctx.drawImage(image, sx, sy, sWidth, sHeight, 0, posY, displayWidth, displayHeight);
